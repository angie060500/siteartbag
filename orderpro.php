...
<div class="container">
        ...
        <div class="main">
	       ...
	       <?php } ?>
                <h2 class="card-title">Products ordre <?php echo " - $fact - "?></h2>
                <table class="table table-striped">
                    ...
                    <tr>
                    <?php 
                  $sql1 ="SELECT * FROM commande WHERE ord='$fact'" ;
                  $result1= mysqli_query($conn, $sql1);
                  if(mysqli_num_rows($result1)>0){
                      while($row1= mysqli_fetch_assoc($result1))  {
                          $p=$row1['idart']; 
                  $sql ="SELECT * FROM article WHERE idarticle=$p " ;
                ...
                <a href="aorders.php" class="btn">Back </a>
            </div>
        </div>
