      ...
      <div class="col-2">
	     ...
	     <?php } ?>
            ...
            <form id="" action="updateuser.php" method="POST">
                ...
                <input type="password" id="password1" name="password1" placeholder="Password" requested>
                <label> Confirm : </label>
                <input type="password" id="password2" name="password2" placeholder="Password" requested>
